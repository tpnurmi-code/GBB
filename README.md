...
The document below describes the project, its scope, validation strategy, and future development plans: [GBB project research plan](./docs/GBB_project_research_plan.pdf)
